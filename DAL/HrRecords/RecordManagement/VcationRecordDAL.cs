...
{
    public class VcationRecordDAL : CommonDB
    {
        ...
        public List<VcationRecordDL> GetVacationRecordData(decimal EmpSerial_No, string VacationFrom, string VacationTo, string Company_Id, string Branch_Id)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
            ...
            try
            {
                ...
                new SqlParameter("@VacationFrom",VacationFrom),
                new SqlParameter("@VacationTo",VacationTo),
                ...
                var objlist = objPharmaEntities.Database.SqlQuery<VcationRecordDL>("exec dbo.sp_GetEmpVacationRecord @Emp_Serial_No, @VacationFrom, @VacationTo,@Company_Id,@Branch_Id", param1).ToList();
                ...
                foreach (var obj in objlist)
                {
                    ...
                    //VcationRecordDL.OverTimeDate = obj.OverTimeDate;
                    //// EmpOverTimeRecordDL.Rec_Order_No = "0";
                    //// EmpOverTimeRecordDL.Rec_Order_HdrId = maxId;
                    //VcationRecordDL.FromTime = obj.FromTime;
                    //VcationRecordDL.ToTime = obj.ToTime;
                    //VcationRecordDL.OverTime_Period = obj.OverTime_Period;
                    ...
                    //VcationRecordDL.Commissioner_Serial_no = obj.Emp_Serial_No;
                    //VcationRecordDL.DayType = obj.DayType;
        ...
        public List<VacationData> CalcEmpAnnualVactionPerRquest(decimal EmpSerial_No,string Company_Id, string Branch_Id,string FromDate, string ToDate)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
