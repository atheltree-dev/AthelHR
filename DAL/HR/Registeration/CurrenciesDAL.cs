...
{
    public class CurrenciesDAL : CommonDB

    {
        public  async Task<int> Insert(Hr_Currencies objInsert) 
        {
        ...
        public async Task<bool> Update(Hr_Currencies objUpdate)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
        ...
        public bool DeleteTask(Hr_Currencies objDelete)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
        ...
        public List<Hr_Currencies> GetAll()
        {
            ...
            try
            {
                ...
                List<Hr_Currencies> objectList = (from objLinq in objPharmaEntities.Hr_Currencies
        ...
        public string GetNewId()
        {
            ...
            try
            {
                // maxId = objPharmaEntities.Database.ExecuteSqlCommand("exec dbo.SP_Hr_Currencies_SelectMaxId");
                //maxId = (from anything in objPharmaEntities.SP_Hr_Currencies_SelectMaxId()
                //         select anything.Currency_Id).Single();
                //foreach (Hr_Currencies cs in objPharmaEntities.Hr_Currencies)
                //    maxId = cs.Currency_Id;

                OpenEntityConnection();

                maxId = objPharmaEntities.Database.SqlQuery<string>("select top 1 Currency_Id  as Currency_Id  from Hr_Currencies  order by replicate('0',15-len(Currency_Id))+Currency_Id desc").FirstOrDefault<string>();
