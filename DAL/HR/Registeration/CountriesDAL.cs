...
{
    public class CountriesDAL : CommonDB

    {
        ...
        //}
        public int InsertTask(Hr_Countries objInsert)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
        ...
        public async Task<bool> Update(Hr_Countries objUpdate)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
            ...
            try
            {
                ...
                {
                    OpenEntityConnection();
                    Hr_Countries ObjForUpdate = (from objLinq in objPharmaEntities.Hr_Countries
                                            where objLinq.Country_Id == objUpdate.Country_Id
        ...
        public bool UpdateTask(Hr_Countries objUpdate)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
        ...
        public async Task<bool> Delete(Hr_Countries objDelete)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
            ...
            try
            {
                if (objDelete != null) //Definsive Programming
                {
                    ...
                    Hr_Countries objForDelete = (from objLinq in objPharmaEntities.Hr_Countries
                                            where objLinq.Country_Id == objDelete.Country_Id
                                            select objLinq).FirstOrDefault();
        ...
        public bool DeleteTask(Hr_Countries objDelete)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
        ...
        public Hr_Countries GetById(string Country_ID)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
            ...
            {
                OpenEntityConnection();
                Hr_Countries CountriesForGetEntity = (from objLinq in objPharmaEntities.Hr_Countries
                                            where objLinq.Country_Id == Country_ID && objLinq.Rec_Status == 0
                                            select objLinq).FirstOrDefault();
        ...
        public List<Hr_Countries> GetAll()
        {
            ...
            try
            {
                ...
                List<Hr_Countries> objectList = (from objLinq in objPharmaEntities.Hr_Countries
        ...
        public string GetNewId()
        {
            ...
            try
            {
                ...
                maxId = objPharmaEntities.Database.SqlQuery<string>("select top 1 Country_Id  as Country_Id  from Hr_Countries  order by replicate('0',15-len(Country_Id))+Country_Id desc").FirstOrDefault<string>();
