...
{
  public  class EmpSecondmentRequestDAL:CommonDB

    {
        ...
        //}
        public int InsertTask(Hr_EmpSecondmentRequest objInsert)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
        ...
        public List<EmpSecondmentRequestDL> SelectAllByCompanyAndBranch(string strcomapny, string strbranch)
        {
            ...
            try
            {
                ...
                foreach (var obj in objlist)
                {
                    ...
                    objEmpSecondmentRequestDL.State = obj.State;
                    objEmpSecondmentRequestDL.Notes = obj.Notes;
                    objEmpSecondmentRequestDL.Reason = obj.Reason;
                    objEmpSecondmentRequestDL.SecondmentType = obj.SecondmentType;
                    objEmpSecondmentRequestDL.Order_Status = obj.Order_Status;
                    objEmpSecondmentRequestDL.RequestTypeNameEn = obj.RequestTypeNameEn;
                    objEmpSecondmentRequestDL.StatusNameEn = obj.StatusNameEn;
        ...
        public Hr_EmpSecondmentRequest GetRequestByHdrId(string strCompanyNo, string strBranchNo, Guid RequestHdrId) 
        {
            ...
            try
            {
                ...
                sql = sql + ",Emp_Serial_No,FromSecondmentDate,ToSecondmentDate,ExpectedValue,City,State,Notes,Reason,DocumentPath,Order_Status,Commissioner_Serial_no,SecondmentType,DailySecondmentValue";
                sql = sql + " from Hr_EmpSecondmentRequest where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Rec_Hdr_Id = '" + RequestHdrId + "'";


                Hr_EmpSecondmentRequest obj = objPharmaEntities.Database.SqlQuery<Hr_EmpSecondmentRequest>(sql).FirstOrDefault();
                return obj;
