...
{
  public  class EmpEmploymentRequestDAL:CommonDB

    {
        ...
        //}
        public int InsertTask(Hr_EmpEmploymentRequest objInsert)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
        ...
        public List<EmpEmploymentRequestDL> GetAll()
        {
            ...
            try
            {
                ...
                List<EmpEmploymentRequestDL> objectList = new List<EmpEmploymentRequestDL>();
                var objlist = (from objLinq in objPharmaEntities.Hr_EmpEmploymentRequest
                               ...
                               select new 
                               {
                                   ...
                                   Admin_Id = objLinq.Admin_Id,
                                   Dept_Id = objLinq.Dept_Id,
                                   WithinBudget = objLinq.WithinBudget,
                ...
                {
                    EmpEmploymentRequestDL objEmpEmploymentRequestDL = new EmpEmploymentRequestDL();
                    objEmpEmploymentRequestDL.Rec_Hdr_Id = obj.Rec_Hdr_Id;
                    objEmpEmploymentRequestDL.ReferenceNo = obj.ReferenceNo;
                    objEmpEmploymentRequestDL.Request_Id = obj.Request_Id;
                    objEmpEmploymentRequestDL.Emp_Serial_No = obj.Emp_Serial_No;
                    objEmpEmploymentRequestDL.WithinBudget = obj.WithinBudget;
                    objEmpEmploymentRequestDL.Admin_Id = obj.Admin_Id;
                    objEmpEmploymentRequestDL.Dept_Id = obj.Dept_Id;
                    objEmpEmploymentRequestDL.Order_Status = obj.Order_Status;
                    objEmpEmploymentRequestDL.RequestTypeNameEn = obj.RequestTypeNameEn;
                    objEmpEmploymentRequestDL.StatusNameEn = obj.StatusNameEn;
                    objEmpEmploymentRequestDL.RequestTypeName = obj.RequestTypeName;
                    objEmpEmploymentRequestDL.StatusName = obj.StatusName;
                    objectList.Add(objEmpEmploymentRequestDL);
        ...
        public List<EmpEmploymentRequestDL> SelectAllByCompanyAndBranch(string strcomapny, string strbranch)
        {
            ...
            try
            {
                ...
                foreach (var obj in objlist)
                {
                    ...
                    objEmpEmploymentRequestDL.Admin_Id = obj.Admin_Id;
                    objEmpEmploymentRequestDL.Dept_Id = obj.Dept_Id;
                    objEmpEmploymentRequestDL.Notes = obj.Notes;
                    objEmpEmploymentRequestDL.Order_Status = obj.Order_Status;
                    objEmpEmploymentRequestDL.RequestTypeNameEn = obj.RequestTypeNameEn;
                    objEmpEmploymentRequestDL.StatusNameEn = obj.StatusNameEn;
                    objEmpEmploymentRequestDL.RequestTypeName = obj.RequestTypeName;
        ...
        public bool chkEmploymentIndivisible(string strRequestType)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
        ...
        //public async Task<bool> Update(Hr_EmpEmploymentRequest objUpdate)
        //{
        //    StackFrame stackFrame = new StackFrame();
        //    MethodBase methodBase = stackFrame.GetMethod();
        ...
        //        {
        //            OpenEntityConnection();
        //            Hr_EmpEmploymentRequest ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpEmploymentRequest
        ...
        //}
        //public bool UpdateTask(Hr_EmpEmploymentRequest objUpdate)
        //{
        //    StackFrame stackFrame = new StackFrame();
        //    MethodBase methodBase = stackFrame.GetMethod();
        ...
        public string GetNewId(string strcompanyId, string strBranch_Id)
        {
            ...
            try
            {
                ...
                maxId = objPharmaEntities.Database.SqlQuery<string>("select top 1 ReferenceNo  as ReferenceNo  from Hr_EmpEmploymentRequest where Company_Id ='" + strcompanyId + "' and Branch_Id= '" + strBranch_Id + "'  order by replicate('0',15-len(ReferenceNo))+ReferenceNo desc").FirstOrDefault<string>();
