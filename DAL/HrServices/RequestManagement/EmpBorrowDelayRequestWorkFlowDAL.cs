...
{
    public class EmpBorrowDelayRequestWorkFlowDAL : CommonDB

    {
        ...
        public bool UpdateTask(Hr_EmpBorrowDelayRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpBorrowDelayRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpBorrowDelayRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpBorrowDelayRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
