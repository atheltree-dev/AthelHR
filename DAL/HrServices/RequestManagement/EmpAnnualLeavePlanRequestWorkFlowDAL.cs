...
{
  public  class EmpAnnualLeavePlanRequestWorkFlowDAL:CommonDB

    {
      ...
      public bool UpdateTask(Hr_EmpAnnualLeavePlanRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpAnnualLeavePlanRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpAnnualLeavePlanRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpAnnualLeavePlanRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
