...
{
  public  class EmpSecondmentRequestWorkFlowDAL:CommonDB

    {
      ...
      public bool UpdateTask(Hr_EmpSecondmentRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpSecondmentRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpSecondmentRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpSecondmentRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
