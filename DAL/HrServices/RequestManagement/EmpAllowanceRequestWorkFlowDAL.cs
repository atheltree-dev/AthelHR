...
{
    public class EmpAllowanceRequestWorkFlowDAL : CommonDB

    {
        ...
        public bool UpdateTask(Hr_EmpAllowanceRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  OpenEntityConnection();
                    ...
                    Hr_EmpAllowanceRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpAllowanceRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpAllowanceRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
