...
{
  public  class EmpCompensatoryVacationRequestWorkFlowDAL : CommonDB

    {
      ...
      public bool UpdateTask(Hr_EmpCompensatoryVacationRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  OpenEntityConnection();
                    ...
                    Hr_EmpCompensatoryVacationRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpCompensatoryVacationRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpCompensatoryVacationRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
