...
{
  public  class EmpTravelTickectRequestWorkFlowDAL:CommonDB

    {
      ...
      public bool UpdateTask(Hr_EmpTravelTickectRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpTravelTickectRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpTravelTickectRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpTravelTickectRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
