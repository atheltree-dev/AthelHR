...
{
  public  class EmpDisciplinaryProcedureRequestWorkFlowDAL:CommonDB

    {

      public bool UpdateTask(Hr_EmpDisciplinaryProcedureRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpDisciplinaryProcedureRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpDisciplinaryProcedureRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpDisciplinaryProcedureRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
