...
{
  public  class EmpPermissionRequestDAL:CommonDB

    {
      ...
      public class EmpPermissionStatusDL
      {
        ...
        public  async Task<int> Insert(Hr_EmpPermissionRequest objInsert) 
        {
            ...
            try
            {
                if (objInsert != null)
                {
                    ...
                    objPharmaEntities.Hr_EmpPermissionRequest.Add(objInsert);
        ...
        //}
        public int InsertTask(Hr_EmpPermissionRequest objInsert)
        {
            StackFrame stackFrame = new StackFrame();
            MethodBase methodBase = stackFrame.GetMethod();
        ...
        public List<EmpPermissionRequestDL> GetAll()
        {
            ...
            try
            {
                ...
                List<EmpPermissionRequestDL> objectList = new List<EmpPermissionRequestDL>();
                var objlist = (from objLinq in objPharmaEntities.Hr_EmpPermissionRequest
                               ...
                               join ReqReason in objPharmaEntities.Hr_PermissionReasons on objLinq.Permission_Reason_Id equals ReqReason.PermissionReason_Id
                               join ReqSubReason in objPharmaEntities.Hr_PermissionSubReasons on objLinq.Permission_Reason_Sub_Id equals ReqSubReason.PermissionSubReason_Id
                               ...
                               select new 
                               {
                                   ...
                                   StatusName = Reqstatus.RequestStatus_Name,
                                    ...
                                    Permission_Type = objLinq.Permission_Type,
                                    Permission_TypeName = "",
                                    Permission_TypeNameEn = "",

                                   Permission_Reason_Id = objLinq.Permission_Reason_Id,
                                   PermissionReason_Name = ReqReason.PermissionReason_Name,
                                   PermissionReason_NameEn = ReqReason.PermissionReason_NameEn,

                                   Permission_Reason_Sub_Id = objLinq.Permission_Reason_Sub_Id,
                                   PermissionSubReason_Name = ReqSubReason.PermissionSubReason_Name,
                                   PermissionSubReason_NameEn = ReqSubReason.PermissionSubReason_NameEn
                ...
                {
                    EmpPermissionRequestDL objEmpPermissionRequestDL = new EmpPermissionRequestDL();
                    objEmpPermissionRequestDL.Rec_Hdr_Id = obj.Rec_Hdr_Id;
                    objEmpPermissionRequestDL.ReferenceNo = obj.ReferenceNo;
                    objEmpPermissionRequestDL.Request_Id = obj.Request_Id;
                    objEmpPermissionRequestDL.Emp_Serial_No = obj.Emp_Serial_No;
                    objEmpPermissionRequestDL.PermissionDate = obj.PermissionDate;
                    objEmpPermissionRequestDL.FromTime = obj.FromTime;
                    objEmpPermissionRequestDL.ToTime = obj.ToTime;
                    objEmpPermissionRequestDL.Order_Status = obj.Order_Status;
                    objEmpPermissionRequestDL.RequestTypeNameEn = obj.RequestTypeNameEn;
                    objEmpPermissionRequestDL.StatusNameEn = obj.StatusNameEn;
                    objEmpPermissionRequestDL.RequestTypeName = obj.RequestTypeName;
                    objEmpPermissionRequestDL.StatusName = obj.StatusName;

                    objEmpPermissionRequestDL.Permission_Type = obj.Permission_Type;
                    objEmpPermissionRequestDL.Permission_TypeName = obj.Permission_TypeName;
                    objEmpPermissionRequestDL.Permission_TypeNameEn = obj.Permission_TypeNameEn;

                    objEmpPermissionRequestDL.Permission_Reason_Id = obj.Permission_Reason_Id;
                    objEmpPermissionRequestDL.PermissionReason_Name = obj.PermissionReason_Name;
                    objEmpPermissionRequestDL.PermissionReason_NameEn = obj.PermissionReason_NameEn;

                    objEmpPermissionRequestDL.Permission_Reason_Sub_Id = obj.Permission_Reason_Sub_Id;
                    objEmpPermissionRequestDL.PermissionSubReason_Name = obj.PermissionSubReason_Name;
                    objEmpPermissionRequestDL.PermissionSubReason_NameEn = obj.PermissionSubReason_NameEn;




                    objectList.Add(objEmpPermissionRequestDL);
        ...
        public List<EmpPermissionRequestDL> SelectAllByCompanyAndBranch(string strcomapny, string strbranch)
        {
            ...
            try
            {
                ...
                foreach (var obj in objlist)
                {
                    ...
                    objEmpPermissionRequestDL.FromTime = obj.FromTime;
                    objEmpPermissionRequestDL.ToTime = obj.ToTime;
                    objEmpPermissionRequestDL.Reason = obj.Reason;
                    objEmpPermissionRequestDL.MessageNotesForEmp = obj.MessageNotesForEmp;
        ...
        public Hr_EmpPermissionRequest GetRequestByHdrId(string strCompanyNo, string strBranchNo, Guid RequestHdrId) 
        {
            ...
            try
            {
                ...
                sql = sql + ",Contract_Id,ContractPeriod_Id,Permission_Type,Permission_Reason_Id,Permission_Reason_Sub_Id";
                sql = sql + " from Hr_EmpPermissionRequest where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Rec_Hdr_Id = '" + RequestHdrId + "'";


                Hr_EmpPermissionRequest obj = objPharmaEntities.Database.SqlQuery<Hr_EmpPermissionRequest>(sql).FirstOrDefault();
                return obj;

             //  EmpPermissionRequestDL objectList = new EmpPermissionRequestDL();

                //Hr_EmpPermissionRequest obj = (from objLinq in objPharmaEntities.Hr_EmpPermissionRequest
                ...
                //Hr_EmpPermissionRequest obj = objPharmaEntities.Hr_EmpPermissionRequest
        ...
        //public async Task<bool> Update(Hr_EmpPermissionRequest objUpdate)
        //{
        //    StackFrame stackFrame = new StackFrame();
        //    MethodBase methodBase = stackFrame.GetMethod();
        ...
        //        {
        //            OpenEntityConnection();
        //            Hr_EmpPermissionRequest ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpPermissionRequest
        ...
        //}
        //public bool UpdateTask(Hr_EmpPermissionRequest objUpdate)
        //{
        //    StackFrame stackFrame = new StackFrame();
        //    MethodBase methodBase = stackFrame.GetMethod();
        ...
        public string GetNewId(string strcompanyId, string strBranch_Id)
        {
            ...
            try
            {
                ...
                maxId = objPharmaEntities.Database.SqlQuery<string>("select top 1 ReferenceNo  as ReferenceNo  from Hr_EmpPermissionRequest where Company_Id ='" + strcompanyId + "' and Branch_Id= '" + strBranch_Id + "'  order by replicate('0',15-len(ReferenceNo))+ReferenceNo desc").FirstOrDefault<string>();
