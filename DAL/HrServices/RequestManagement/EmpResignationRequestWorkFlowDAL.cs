...
{
  public  class EmpResignationRequestWorkFlowDAL:CommonDB

    {
      ...
      public bool UpdateTask(Hr_EmpResignationRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpResignationRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpResignationRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpResignationRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
