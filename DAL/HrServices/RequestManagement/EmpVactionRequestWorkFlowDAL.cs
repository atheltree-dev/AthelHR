...
{
  public  class EmpVactionRequestWorkFlowDAL:CommonDB

    {
      ...
      public bool UpdateTask(Hr_EmpVactionRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpVactionRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpVactionRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              List<EmpVactionRequestWorkFlowDL> objectList = new List<EmpVactionRequestWorkFlowDL>();
                ...
                sql = sql + " FROM [VwEmpVactionRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
