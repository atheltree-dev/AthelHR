...
{
    public class EmpJobMissionRequestWorkFlowDAL : CommonDB

    {
        ...
        public bool UpdateTask(Hr_EmpJobMissionRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpJobMissionRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpJobMissionRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpJobMissionRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
