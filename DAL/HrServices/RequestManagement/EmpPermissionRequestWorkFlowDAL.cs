...
{
    public class EmpPermissionRequestWorkFlowDAL : CommonDB

    {
        ...
        public bool UpdateTask(Hr_EmpPermissionRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpPermissionRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpPermissionRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpPermissionRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
