...
{
  public  class EmpDismissalRequestWorkFlowDAL:CommonDB

    {

      public bool UpdateTask(Hr_EmpDismissalRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpDismissalRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpDismissalRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpDismissalRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
