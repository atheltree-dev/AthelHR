...
{
  public  class EmpEmploymentRequestWorkFlowDAL:CommonDB

    {
      ...
      public bool UpdateTask(Hr_EmpEmploymentRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpEmploymentRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpEmploymentRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpEmploymentRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
