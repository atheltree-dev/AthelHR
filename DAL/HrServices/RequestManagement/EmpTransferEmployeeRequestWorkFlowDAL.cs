...
{
  public  class EmpTransferEmployeeRequestWorkFlowDAL:CommonDB

    {
      ...
      public bool UpdateTask(Hr_EmpTransferEmployeeRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpTransferEmployeeRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpTransferEmployeeRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpTransferEmployeeRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
