...
{
  public  class EmpRewardRequestWorkFlowDAL:CommonDB

    {
      ...
      public bool UpdateTask(Hr_EmpRewardRequestWorkFlow objUpdate)
      {
          ...
          try
          {
              ...
              if (objUpdate != null) //Definsive Programming
              {
                  ...
                  Hr_EmpRewardRequestWorkFlow ObjForUpdate = (from objLinq in objPharmaEntities.Hr_EmpRewardRequestWorkFlow
      ...
      public List<EmpVactionRequestWorkFlowDL> GetRequestHistory(string strCompanyNo, string strBranchNo,Guid RequestHdrId) 
      {
          ...
          try
          {
              ...
              sql = sql + " FROM [VwEmpRewardRequestWorkFlowHistory] where  Company_Id='" + strCompanyNo + "' and Branch_Id='" + strBranchNo + "' and Hdr_Id = '" + RequestHdrId + "'";
