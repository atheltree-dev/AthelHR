...
namespace DAL
{
    ...
    public partial class Hr_EmpAllowanceRecord
    {
        ...
        public Nullable<decimal> ActualDailyAllowance { get; set; }
        public Nullable<decimal> ActualHousingAllowance { get; set; }
        public Nullable<decimal> ActualTransportAllowance { get; set; }
        public Nullable<decimal> ActualFuelAllowance { get; set; }
        ...
        public Nullable<byte> IsActualDone { get; set; }
        public Nullable<decimal> DirectManagerEmp_Serial_No { get; set; }
        public Nullable<byte> ManagerConfirmed { get; set; }
        public string ManagerComment { get; set; }
        public string ManagerCommentDate { get; set; }
        public Nullable<decimal> HrManagerEmp_Serial_No { get; set; }
        public Nullable<byte> HRMangerConfirmed { get; set; }
