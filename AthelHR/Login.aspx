<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AthelHR.Login" %>
...
<head>
    ...
    <link href="spStyles/Loader.css" rel="stylesheet" />
...
<%--                <div class="loading"><img src="assets/global/img/loading.svg" /></div>--%>

          <div id="overlay"  style="display: none;" class="overlay"></div>


        <div id="Loader" style="display: none; align-content: center; width: 100%; margin-left: 45%; margin-right: 45%">
            <img src="images/loading.svg" style="align-self: center" />
        </div>
            ...
            <div class="col-md-6 login-container bs-reset">
                ...
                <div class="login-content">
                    ...
                    <form action="javascript:;" class="login-form" method="post">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <input class="form-control form-control-solid placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="Username or Email" name="username" id="txtUserName" required />
                            </div>
                            <div class="col-xs-6">
                                <input class="form-control form-control-solid placeholder-no-fix form-group" type="password" autocomplete="off" placeholder="Password" name="password" id="txtPassword" required />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12" id="GotoCompanies">
                                <div class="form-group">
                                    <a id="GotoCompaniesLink" href="#">Go To Companies</a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4" style="display: none;">
                                <label class="rememberme mt-checkbox mt-checkbox-outline">
                                    <input type="checkbox" name="remember" id="ChkRememberMe" value="1" />
                                    Remember me
                                        <span></span>
                                </label>
                            </div>
                            <div class="col-sm-12 text-right">
                                ...
                                <%--<input type="button" id="testsign" onclick="ResetPassword();"/>--%>
                            </div>
                        </div>
                    ...
                    <form class="forget-form" action="javascript:;" method="post">
                        ...
                        <div class="form-group">
                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="email" id="txtEmail" />
                        </div>
                        <div class="form-actions">
                            <button type="button" id="back-btn" class="btn blue btn-outline">Back</button>
                            <button type="button" id="Submit-btn" class="btn blue uppercase pull-right">Submit</button>
                        </div>
                    </form>
...
<![endif]-->
    ...
    <%--    <script src="<%= Page.ResolveClientUrl("~/Login.js") %>"></script>--%>
    <script src="Login.js?bust_js_cache=<%=System.IO.File.GetLastWriteTime(Server.MapPath("Login.js")).ToString("HH:mm:ss")%>" type="text/javascript"></script>
